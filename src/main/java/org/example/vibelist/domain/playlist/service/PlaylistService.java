...
public class PlaylistService {
     ...
     */
    public RsData<SpotifyPlaylistDto> createPlaylist(Long userId, List<TrackRsDto> tracks) {
        try {
            ...
            return RsData.success(ResponseCode.PLAYLIST_CREATED, spotifyPlaylistDto);
        } catch (GlobalException ce) {
            throw ce;
        } catch (Exception e) {
            throw new GlobalException(ResponseCode.INTERNAL_SERVER_ERROR, "플레이리스트 생성 중 오류 - userId=" + userId + ", error=" + e.getMessage());
        }
    }
